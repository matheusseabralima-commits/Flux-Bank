 ...
 * IMPORTANTE: Alterado para resolver erro do Blowfish
 */
	Configure::write('Security.salt', '8d3410a568c2d28b1e4f9b5c7a2d6e3f1a9b8c7d6e5f4a3b2c1d0e9f8a7b6c5d');

/**
 * A random numeric string (digits only) used to encrypt/decrypt strings.
 * IMPORTANTE: Alterado para um valor novo
 */
	Configure::write('Security.cipherSeed', '39485761203948576120394857612039485');
